				...
				<div class="row">
					...
					<div class="col-md-10 col-md-offset-1">
						<div class="home-content">
							...
							<p class="white-text">Вэб сонирхогчид, анхлан суралцагсадад зориулагдсан веб дизайн болон веб программчлалын тухай хичээлүүд мөн хэлэлцүүлэг блог, код бичих хэсгүүдээс бүрдсэн.
							</p>
							<a href="lesson.php"><button class="white-btn">Хичээлүүд</button></a>
							<a href="code.php"><button class="main-btn">Код бичих</button></a>
						</div>
					</div>
					<!-- /Зураг дээрх -->
			</div>
			...
			<div class="row">
				...
				<div class="col-md-4 col-sm-6">
					<div class="service">
						...
						<h3>Сургалт</h3>
						<p>Веб суралцигчид зориулагдсан бүх төрлийн хичээлүүдийг агуулсан</p>
					</div>
				</div>
				<div class="col-md-4 col-sm-6">
					<div class="service">
...
<!--Блог дахь хэрэглэгч, нийтлэл, сэтгэгдлийн тоо-->
